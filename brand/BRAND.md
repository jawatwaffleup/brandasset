...
**Merlulu** — a pink-maned lion with a gold W medallion, and the tenth character. **Redesigned Aug 2026: he is a lion, not a Merlion** — no fish half, no fin. A pro badminton player and the group's tech head. **Universal since 24 Aug 2026** — he was originally Singapore-only, which is now historical. Singapore origin is part of his story, not a limit on where he appears. Its approved Surprise Card description is: “Boldly be playful, Merlulu loves making worlds together. Just like a lion and a fish! No wonder he's a fan of Waffle Up's bold flavors with a smooth twist.” The printed card and the SG sticker sheets carry the **superseded** Merlion artwork; a reprint is due. He is the tenth Surprise Card character, in Batch 11 (May 26).
