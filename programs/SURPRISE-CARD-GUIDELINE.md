...
> **Merlulu is not precious, he is unique.** His point value is set at the same level as Air Maxi's — a good card, not a jackpot. What makes him worth having is that he completes the Gang, and that he comes from Singapore, where Waffle Up Global was founded — a story that tells itself whether or not the card is scarce. **He is a lion, not a Merlion** (redesigned 31 Aug 2026); the printed card still carries the retired Merlion art and is due a reprint. **[CONFIRMED]**
